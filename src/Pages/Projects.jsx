  ...
  return (
    <motion.div  
        ...
        <div className='flex justify-end items-center mb-8 '>
            <button onClick={preProject} className='p-3 bg-gray-200 rounded mr-2 cursor-pointer hover:invert  hover:scale-110 hover:opacity-80 transition duration-200 ' aria-label='Previous Project' >
                <img src={assets.left_arrow} alt="Previous" />
            </button>
            <button onClick={nextProject} className='p-3 bg-gray-200 rounded mr-2 cursor-pointer hover:invert  hover:scale-110 hover:opacity-80 transition duration-200 ' aria-label='Next Project' >
