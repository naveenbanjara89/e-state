    ...
    <motion.div 
      ...
      <div className=' container mx-auto flex flex-col md:flex-row justify-between items-start '>
        <div className='w-full md:w-1/3 mb-8 md:mb-0 '>
          ...
          <Link to='/' onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} ><img src={assets.logo_dark} alt="" /></Link>
          <p className='mt-4 text-gray-400'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text.</p>
        ...
        <div className='w-full md:w-1/3'>
          ...
          <button className='py-2 mx-2 px-4 rounded bg-blue-600 cursor-pointer hover:bg-blue-500 text-white'>Subscribe</button>
        </div>
      </div>
