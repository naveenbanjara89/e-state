        ...
        <motion.div
          ...
          className='container text-center mx-auto py-4 px-6 md:px-20 lg:px-32 text-white  '>
            ...
            <div className=' space-x-6 mt-16 '>
                <a className=' border border-gray-400 hover:bg-gray-500 px-8 py-3 rounded cursor-pointer ' href='#Projects'>Projects</a>
                <a className=' bg-blue-500 hover:bg-blue-700 px-8 py-3 rounded cursor-pointer ' href='#Contact'>Contact Us</a>
            </div>
        </motion.div>
    </div>
  )
